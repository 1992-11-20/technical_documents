...
u["+"+q]=n
u["*"+q]=n}}},
Ds:function(){var u,t,s,r,q,p,o=C.ba()
o=H.eJ(C.bb,H.eJ(C.bc,H.eJ(C.ap,H.eJ(C.ap,H.eJ(C.bd,H.eJ(C.be,H.eJ(C.bf(C.ao),o)))))))
...
return P.fN(a,b,c,C.K,!0)}if(d==null)return
u=new P.a5("")
t.a=""
...
this.b=b}},B={aM:function aM(a,b,c){this.a=a
this.b=b
...
l.fK(s,b)
m=new G.oT(new O.pi(new D.lt(l,b,a),k,u,t),m,C.b5,new H.aK([n,L.cG]))
...
_.d=d},
bj:function bj(){},
pp:function pp(){}},T={k2:function k2(){},o6:function o6(a){this.a=a},uM:function uM(){},uL:function uL(){},
yF:function(){O.AC(new O.lB(C.at))
$.w8().hg().bi(0,P.yk())}},S={pO:function pO(){},ps:function ps(){}},D={o7:function o7(a){this.a=a},o8:function o8(a){this.a=a},nJ:function nJ(a){this.a=a},nK:function nK(){},q4:function q4(){},po:function po(){},lt:function lt(a,b,c){var _=this
_.cy=_.cx=0
_.f=a
_.a=b
_.b=c
...
return u.gp(u)}}
H.mk.prototype={
gD:function(a){return new H.ml(J.a3(this.a),this.b,C.W,this.$ti)},
$ak:function(a,b){return[b]}}
H.ml.prototype={
gp:function(a){return this.d},
...
if(typeof s!=="number")return H.w(s)
o.c=r+s},
eR:function(a){this.a.$1(C.M.bm(this.b,0,this.c))},
...
bw:function(a){return C.aH.ao(a)},
aD:function(a,b){var u
H.n(b,"$ii",[P.j],"$ai")
u=C.bC.ao(b)
return u},
...
n=s-1
if(n<0||n>=4)return H.m(C.aI,n)
if(u<=C.aI[n]){n=P.a0("Overlong encoding of 0x"+C.c.bE(u,16),a,p-s-1)
...
t=C.a.b1(u,"?",o)
s=u.length
if(t>=0){r=P.fN(u,t+1,s,C.K,!1)
s=t}else r=p
return q.c=new P.qN(q,"data",p,p,p,P.fN(u,o,s,C.aL,!1),r,p)},
k:function(a){var u,t=this.b
...
u=C.aR.b_(u.createElement("table"),b,c,d)
u.toString
u=new W.b3(u)
s=u.gbX(u)
s.toString
...
t=s.e
C.b.l(t,u)
if(t.length===1)P.ev(C.bo,new G.kG(s))},
...
c.il=t
if(r===C.Z||p){t=u.querySelector("#console-output-header")
...
lc:function(){C.aX.mD(window,"message",new O.lO(this))},
...
if(t==="master")return C.F
else if(t==="dev")return C.aB
else if(t==="beta")return C.aC
else return C.aD},
...
$.z7()
j.a.j(0,C.aW,new B.f4(i,new O.eV(P.x4(W.cY))))
...
i=n.a.a
if(i===C.Z||i===C.a_){t=H.o([j.querySelector("#editor-and-console-container"),u],[W.I])
s=!0}else{r=[W.I]
if(i===C.at){q=j.querySelector(m)
p=j.querySelector(l)
p.removeAttribute(k)
t=H.o([q,p],r)
...
s.a.bG(0,t)
u=p.a.a
if(u===C.Z){u=H.E(X.aa().a0(C.r),"$ic7")
u.toString
...
s+=H.h(B.dY(r)?r:"")
r=u.ac("id")
C.aX.nq(t,s,"DartPad_"+H.h(B.dY(r)?r:""))
return},
$S:11}
O.m7.prototype={
...
a=H.E(H.e(a,"$iG"),"$ie3")
switch(H.yz(J.ah((a&&C.bk).gmV(a),"index"))){case 0:u=this.a
t=u.k2
u.k2=!t
s=u.go
s.toString
...
break
case 2:u=4
return P.aF(s.f.mh("Show solution?",'If you just want a hint, click <span style="font-weight:bold">Cancel</span> and then <span style="font-weight:bold">Hint</span>.',"Cancel","Show solution",C.ar,C.bm),$async$bW)
...
F.ld.prototype={
it:function(a){var u
X.aa().a.j(0,C.r,new Y.c7(new F.ph(P.x4(W.cY)),"https://dart-services.dartpad.cn/"))
u=new P.Z($.J,[null])
u.bd(null)
return u}}
Q.nU.prototype={
...
case 3:p=c
o=p.b
if(o===404)throw H.a(C.aF)
else if(o===403)throw H.a(C.aG)
else if(o!==200)throw H.a(C.aE)
...
while(true)switch(u){case 0:if(b===C.aC||b===C.aB)throw H.a(P.P("Only stable and master channels are supported!"))
q=b===C.F?"https://master-api.flutter.dev/snippets/"+H.h(a)+".dart":"https://api.flutter.dev/snippets/"+H.h(a)+".dart"
u=3
...
else if(c===403)throw H.a(B.du(C.G,null))
...
j=J.x(c)
if(!!j.$ihy){m=c
throw H.a(B.du(C.H,"Issue parsing metadata: "+H.h(m)))}else if(!!j.$ic9){l=c
throw H.a(B.du(C.H,"Issue parsing metadata: "+H.h(l)))}else throw a2}c=o.c
j=[P.a4,P.c]
c.toString
i=H.d(c,0)
u=4
...
case 3:n=c
if(n.b===404)throw H.a(B.du(C.H,null))
else{p=r.f.b
if(p===403)throw H.a(B.du(C.G,null))
...
C.bl.d1(u,J.zI(u.innerHTML,"<dt>"+H.h(a)+"</dt><dd>"+t+"</dd>"))},
$S:97}
V.aW.prototype={
...
else a=(u&2)!==0?M.xu(H.jA(t.as(c,new M.r1()),"$ik")):M.dO(a,C.I.gI(H.e(c,"$ier")))
return a}}
M.r1.prototype={
...
H.u(a)
u=this.a
return this.b.$2(u.f.c.h(0,a),"["+H.h(C.I.gaS(u.f.b.h(0,a)))+"]")},
$S:113}
M.ap.prototype={
...
case 512:if(typeof a==="string"){u=o.c?C.I.bz(b.y,new M.tG(a),new M.tH()):C.I.bz(b.y,new M.tI(a),new M.tJ())
...
k+=l.eM(a+"  ")
j.a=k
j.a=k+(a+"}\n")}else{if(!!k.$ikd)l=C.aN.fv(l,0,C.an)
j.a+=a+H.h(q)+": "+H.h(l)+"\n"}}}u=j.a
return u.charCodeAt(0)==0?u:u},
...
return s^t}else if(!!t.$ik){t=C.b9.f2(0,t.a4(a,U.ys(),null))
...
if(q.c===C.ae)return
u=q.bj(0)
if(u.gq(u)===C.ay){r.c=r.c.aE(0,u.gv(u))
return}H.E(u,"$ihd")
t=r.di(q.bj(0))
s=H.E(q.bj(0),"$ieZ")
q=u.a.aE(0,s.a)
...
switch(a.gq(a)){case C.au:return s.lq(H.E(a,"$ifW"))
case C.aw:H.E(a,"$iaT")
u=a.c
if(u==="!"){t=new Z.b2(a.d)
...
t.a=a.a}}s.eG(a.b,t)
return t
case C.ax:return s.lu(H.E(a,"$iet"))
case C.av:return s.lt(H.E(a,"$iei"))
...
q=this.a
r=q.bj(0)
for(;r.gq(r)!==C.E;){C.b.l(u,this.di(r))
...
switch(r.c){case C.b5:u=r.a.a1()
r.c=C.ad
return new X.b8(C.br,u.gv(u))
case C.ad:return r.lK()
case C.b1:return r.lI()
case C.ac:return r.lJ()
case C.b_:return r.dl(!0)
case C.c7:return r.cC(!0,!0)
case C.c6:return r.bI()
case C.b0:r.a.a1()
return r.hu()
case C.ab:return r.hu()
case C.V:return r.lQ()
case C.aZ:r.a.a1()
return r.ht()
case C.S:return r.ht()
case C.T:return r.lG()
case C.b4:return r.hx(!0)
case C.ag:return r.lN()
case C.b6:return r.lO()
...
t=Y.ae(t.a,t.b)
s=t.b
return new X.b8(C.D,Y.ai(t.a,s,s))
case C.b3:return r.hv(!0)
case C.U:return r.lL()
case C.af:return r.lM()
case C.b2:return r.hw(!0)
default:throw H.a("Unreachable")}},
lK:function(){var u,t,s,r=this,q=r.a,p=q.Z()
for(;p.gq(p)===C.O;){q.a1()
p=q.Z()}if(p.gq(p)!==C.R&&p.gq(p)!==C.Q&&p.gq(p)!==C.P&&p.gq(p)!==C.A){r.hE()
C.b.l(r.b,C.ac)
r.c=C.b_
q=p.gv(p)
q=Y.ae(q.a,q.b)
...
q.a1()
return new X.b8(C.ay,p.gv(p))}t=p.gv(p)
s=r.hE()
p=q.Z()
if(p.gq(p)!==C.P)throw H.a(Z.X("Expected document start.",p.gv(p)))
C.b.l(r.b,C.ac)
r.c=C.b1
q.a1()
return X.wG(t.aE(0,p.gv(p)),!1,s.b,s.a)},
lI:function(){var u,t,s=this,r=s.a.Z()
switch(r.gq(r)){case C.R:case C.Q:case C.P:case C.O:case C.A:u=s.b
if(0>=u.length)return H.m(u,-1)
s.c=u.pop()
u=r.gv(r)
u=Y.ae(u.a,u.b)
...
if(b&&n.gq(n)===C.x){q.c=C.V
return new X.et(p.c.aE(0,n.gv(n)),p.b,s,C.X)}if(n instanceof L.dD){if(s==null&&n.c!==C.h)s="!"
u=q.b
if(0>=u.length)return H.m(u,-1)
q.c=u.pop()
o.a1()
...
u=n.b
t=n.c
return new X.aT(o,p.b,s,u,t)}if(n.gq(n)===C.aU){q.c=C.b4
return new X.et(p.c.aE(0,n.gv(n)),p.b,s,C.Y)}if(n.gq(n)===C.aT){q.c=C.b3
return new X.ei(p.c.aE(0,n.gv(n)),p.b,s,C.Y)}if(a&&n.gq(n)===C.aS){q.c=C.b0
return new X.et(p.c.aE(0,n.gv(n)),p.b,s,C.X)}if(a&&n.gq(n)===C.N){q.c=C.aZ
return new X.ei(p.c.aE(0,n.gv(n)),p.b,s,C.X)}if(p.b!=null||s!=null){o=q.b
...
if(0>=s.length)return H.m(s,-1)
t.c=s.pop()
return new X.b8(C.E,r.gv(r))}s=r.gv(r)
...
r=Y.ae(r.a,r.b)
u=r.b
return new X.b8(C.E,Y.ai(r.a,u,u))}u=q.gv(q)
t=Y.ae(u.a,u.b)
r.a1()
q=r.Z()
if(q.gq(q)===C.x||q.gq(q)===C.n||q.gq(q)===C.m||q.gq(q)===C.p){s.c=C.V
r=t.b
return new X.aT(Y.ai(t.a,r,r),null,null,"",C.h)}else{C.b.l(s.b,C.V)
return s.dl(!0)}},
...
return s.cC(!0,!0)}}if(p.gq(p)===C.m){s.c=C.T
q=p.gv(p)
q=Y.ae(q.a,q.b)
u=q.b
...
q.a1()
p=q.Z()
if(p.gq(p)===C.n||p.gq(p)===C.m||p.gq(p)===C.p){s.c=C.S
q=t.b
return new X.aT(Y.ai(t.a,q,q),r,r,"",C.h)}else{C.b.l(s.b,C.S)
return s.cC(!0,!0)}},
...
t=u.Z()}if(t.gq(t)===C.n){s.c=C.b6
u.a1()
return new X.ei(t.gv(t),null,null,C.Y)}else if(t.gq(t)!==C.z){C.b.l(s.b,C.ag)
return s.bI()}}u.a1()
u=s.b
if(0>=u.length)return H.m(u,-1)
s.c=u.pop()
...
u=Y.ae(u.a,u.b)
s=u.b
return new X.aT(Y.ai(u.a,s,s),null,null,"",C.h)}}else if(t.gq(t)!==C.y){C.b.l(r.b,C.b2)
return r.bI()}}u.a1()
u=r.b
if(0>=u.length)return H.m(u,-1)
r.c=u.pop()
return new X.b8(C.D,t.gv(t))},
...
q=r.Z()
if(q.gq(q)!==C.q&&q.gq(q)!==C.y){C.b.l(t.b,C.U)
return t.bI()}}t.c=C.U
r=q.gv(q)
r=Y.ae(r.a,r.b)
u=r.b
...
while(!0){if(!(o.gq(o)===C.R||o.gq(o)===C.Q))break
...
r=n.m6()
if(r!=null){u=n.d
u.aB(0,H.l(r,H.d(u,0)))}return}if(n.bq(3)){if(u.az(0,"---")){n.h9(C.P)
return}if(u.az(0,"...")){n.h9(C.O)
return}}}switch(u.W()){case 91:n.hb(C.aU)
return
case 123:n.hb(C.aT)
return
case 93:n.ha(C.z)
...
n.eH(u.cy,C.aS,Y.ae(u.f,u.c))}n.bt()
n.x=!0
n.bH(C.x)}return
case 63:if(n.cA(1))n.dc()
else{t=n.y
if(t.length===1){if(!n.x)H.B(Z.X("Mapping keys are not allowed here.",u.gaM()))
n.eH(u.cy,C.N,Y.ae(u.f,u.c))}n.x=t.length===1
n.bH(C.n)}return
case 58:if(n.y.length!==1){u=n.d
u=!u.gw(u)}else u=!1
if(u){u=n.d
o=u.ga3(u)
if(o.gq(o)!==C.z)if(o.gq(o)!==C.y)if(o.gq(o)===C.aV){u=H.E(o,"$idD").c
u=u===C.aQ||u===C.aP}else u=!1
else u=!0
else u=!0
if(u){n.he()
...
t=u===43
if(t||u===45){s=t?C.a9:C.aa
a0.M(a0.L())}else s=C.aY}else{s=C.aY
q=0}b.cH()
b.eK()
t=a0.b
p=t.length
...
C.X=new O.h7("BLOCK")
C.Y=new O.h7("FLOW")
C.bm=new E.bt("DialogResult.yes")
C.ar=new E.bt("DialogResult.no")
C.u=new E.bt("DialogResult.ok")
C.v=new E.bt("DialogResult.cancel")
C.as=new P.cw(0)
C.bo=new P.cw(32e3)
C.Z=new O.f0("EmbedMode.flutter")
C.a_=new O.f0("EmbedMode.html")
C.at=new O.f0("EmbedMode.inline")
C.au=new X.bv("ALIAS")
C.bp=new X.bv("DOCUMENT_END")
C.bq=new X.bv("DOCUMENT_START")
C.D=new X.bv("MAPPING_END")
C.av=new X.bv("MAPPING_START")
C.aw=new X.bv("SCALAR")
C.E=new X.bv("SEQUENCE_END")
C.ax=new X.bv("SEQUENCE_START")
C.ay=new X.bv("STREAM_END")
...
C.az=new O.e8("FlashBoxStyle.warn")
C.aA=new O.e8("FlashBoxStyle.success")
C.F=new B.e9("FlutterSdkChannel.master")
C.aB=new B.e9("FlutterSdkChannel.dev")
C.aC=new B.e9("FlutterSdkChannel.beta")
C.aD=new B.e9("FlutterSdkChannel.stable")
C.a0=new B.ec("GistLoaderFailureType.unknown")
C.aE=new B.dt(null,C.a0)
C.a1=new B.ec("GistLoaderFailureType.contentNotFound")
C.aF=new B.dt(null,C.a1)
C.G=new B.ec("GistLoaderFailureType.rateLimitExceeded")
C.aG=new B.dt(null,C.G)
C.H=new B.ec("GistLoaderFailureType.invalidExerciseMetadata")
C.bA=new P.nH(null)
C.bB=new P.nI(null)
C.bC=new P.nP(!1,255)
C.aH=new P.nQ(255)
C.aI=H.o(u([127,2047,65535,1114111]),[P.j])
C.J=H.o(u([0,0,32776,33792,1,10240,0,0]),[P.j])
...
C.K=H.o(u([0,0,65490,45055,65535,34815,65534,18431]),[P.j])
...
C.L=H.o(u([0,0,26624,1023,65534,2047,65534,2047]),[P.j])
C.aJ=H.o(u([0,0,1048576,531441,1048576,390625,279936,823543,262144,531441,1e6,161051,248832,371293,537824,759375,1048576,83521,104976,130321,16e4,194481,234256,279841,331776,390625,456976,531441,614656,707281,81e4,923521,1048576,35937,39304,42875,46656]),[P.j])
...
C.aK=H.o(u([0,0,32754,11263,65534,34815,65534,18431]),[P.j])
C.bR=H.o(u([0,0,32722,12287,65535,34815,65534,18431]),[P.j])
C.aL=H.o(u([0,0,65490,12287,65535,34815,65534,18431]),[P.j])
...
C.a5=new H.mF([C.az,"flash-warn",C.bw,"flash-error",C.aA,"flash-success"],[O.e8,P.c])
...
C.bL=H.o(u([]),[P.cF])
C.aM=new H.br(0,{},C.bL,[P.cF,null])
C.cc=new M.hG("")
C.d=new M.hG("dart_services.api")
C.aP=new O.dC("DOUBLE_QUOTED")
C.bX=new O.dC("FOLDED")
C.bY=new O.dC("LITERAL")
C.h=new O.dC("PLAIN")
C.aQ=new O.dC("SINGLE_QUOTED")
C.bZ=new H.ft("call")
C.c0=new L.as("ALIAS")
C.c1=new L.as("ANCHOR")
C.p=new L.as("BLOCK_END")
C.x=new L.as("BLOCK_ENTRY")
C.N=new L.as("BLOCK_MAPPING_START")
C.aS=new L.as("BLOCK_SEQUENCE_START")
C.O=new L.as("DOCUMENT_END")
C.P=new L.as("DOCUMENT_START")
C.q=new L.as("FLOW_ENTRY")
C.y=new L.as("FLOW_MAPPING_END")
C.aT=new L.as("FLOW_MAPPING_START")
C.z=new L.as("FLOW_SEQUENCE_END")
C.aU=new L.as("FLOW_SEQUENCE_START")
C.n=new L.as("KEY")
C.aV=new L.as("SCALAR")
C.A=new L.as("STREAM_END")
C.c2=new L.as("STREAM_START")
C.c3=new L.as("TAG")
C.Q=new L.as("TAG_DIRECTIVE")
C.m=new L.as("VALUE")
C.R=new L.as("VERSION_DIRECTIVE")
C.i=H.jx(A.aQ)
C.r=H.jx(Y.c7)
C.aW=H.jx(B.f4)
C.t=H.jx(M.bW)
...
C.aZ=new G.ao("BLOCK_MAPPING_FIRST_KEY")
C.S=new G.ao("BLOCK_MAPPING_KEY")
C.T=new G.ao("BLOCK_MAPPING_VALUE")
C.b_=new G.ao("BLOCK_NODE")
C.ab=new G.ao("BLOCK_SEQUENCE_ENTRY")
C.b0=new G.ao("BLOCK_SEQUENCE_FIRST_ENTRY")
C.b1=new G.ao("DOCUMENT_CONTENT")
C.ac=new G.ao("DOCUMENT_END")
C.ad=new G.ao("DOCUMENT_START")
C.ae=new G.ao("END")
C.b2=new G.ao("FLOW_MAPPING_EMPTY_VALUE")
C.b3=new G.ao("FLOW_MAPPING_FIRST_KEY")
C.U=new G.ao("FLOW_MAPPING_KEY")
C.af=new G.ao("FLOW_MAPPING_VALUE")
C.c6=new G.ao("FLOW_NODE")
C.ag=new G.ao("FLOW_SEQUENCE_ENTRY")
C.b4=new G.ao("FLOW_SEQUENCE_FIRST_ENTRY")
C.V=new G.ao("INDENTLESS_SEQUENCE_ENTRY")
C.b5=new G.ao("STREAM_START")
C.ah=new G.ao("FLOW_SEQUENCE_ENTRY_MAPPING_END")
C.ai=new G.ao("FLOW_SEQUENCE_ENTRY_MAPPING_VALUE")
C.b6=new G.ao("FLOW_SEQUENCE_ENTRY_MAPPING_KEY")
...
if(typeof dartMainRunner==="function")dartMainRunner(T.yF,[])
else T.yF([])})})()
